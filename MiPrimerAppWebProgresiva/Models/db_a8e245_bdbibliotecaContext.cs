...
namespace MiPrimerAppWebProgresiva.Models
{
    public partial class db_a8e245_bdbibliotecaContext : DbContext
    {
        public db_a8e245_bdbibliotecaContext()
        {
        }

        public db_a8e245_bdbibliotecaContext(DbContextOptions<db_a8e245_bdbibliotecaContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("server=SQL8001.site4now.net;database=db_a8e245_bdbiblioteca;uid=db_a8e245_bdbiblioteca_admin;pwd=LHurol2022");
            }
        }
